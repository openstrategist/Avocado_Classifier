...
class NNTypeOne:
	...
	def create(self, X_flat_train, num_unique_labels):
		...
		self.model.add(Dense(128, activation='relu', input_shape=(X_flat_train.shape[1],)))
	...
	def train_and_evaluate(self, X_flat_train, X_flat_test, Y_train, Y_test, epochs=10):
		...
		print("NNTypeOne | Evaluating NN: Test loss={:.3f}, Test accuracy={:.3f}".format(score[0], score[1]))
		return score
